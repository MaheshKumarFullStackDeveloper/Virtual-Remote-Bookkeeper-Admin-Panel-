...
export default function TopTextBottomContactForm({ selectedSection, sectionValue, updateSections, updateSelectedSection }: AddProps): React.JSX.Element {
  ...
  } = useForm<TopTextBottomContactForm>({});
  ...
  const onSubmitUpdate = async (data: TopTextBottomContactForm) => {
    ...
    try {
      ...
      const result = await addUpadateSection({ content: JSON.stringify(newContent), title: "TopTextBottomContactForm", pageId: sectionValue.page, order, sectionId: sectionValue._id }).unwrap();
        ...
        <div className="px-2 pr-14">
          ...
          <form
            ...
            <h4 className="mb-2 text-2xl font-semibold text-gray-800 dark:text-white/90">
              Update Top Text Bottom Contact Form
            </h4>
