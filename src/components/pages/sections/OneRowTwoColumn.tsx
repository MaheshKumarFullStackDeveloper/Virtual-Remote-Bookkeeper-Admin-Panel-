...
export default function OneRowTwoColumn({ selectedSection, sectionValue, updateSections, updateSelectedSection }: AddProps): React.JSX.Element {
  ...
  useEffect(() => {
    ...
    if (sectionValue.content !== "") {
      ...
      setValue("mainButtonText", Details.mainButtonText)
      setValue("mainButtonUrl", Details.mainButtonUrl)
              ...
              <div className="mt-7">
                ...
                <div className="grid grid-cols-1 gap-x-6 gap-y-5 ">
                  ...
                  <div className="col-span-1">
                    ...
                    {UpdateError.mainButtonText && (
                      <p className="text-red-700 text-sm">
                        {UpdateError.mainButtonText.message}
                      </p>
                    )}
                  </div>

                  <div className="col-span-1">
                    <Label>Main Button URL </Label>


                    <Input
                      {...registerUpdate("mainButtonUrl", {
                        required: "Section button url is required",
                      })}
                      placeholder="button url "
                      type="text"
                    ...
                    {UpdateError.mainButtonUrl && (
                      <p className="text-red-700 text-sm">
                        {UpdateError.mainButtonUrl.message}
                      </p>
                    )}
                  </div>
