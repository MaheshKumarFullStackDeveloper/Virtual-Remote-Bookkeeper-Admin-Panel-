...
type LeftSideImageRightSideContactForm = {
...
export default function LeftSideImageRightSideContactForm({ selectedSection, sectionValue, updateSections, updateSelectedSection }: AddProps): React.JSX.Element {
  ...
  } = useForm<LeftSideImageRightSideContactForm>({});
        ...
        <div className="px-2 pr-14">
          ...
          <form
            ...
            <h4 className="mb-2 text-2xl font-semibold text-gray-800 dark:text-white/90">
              Update Left Side Text Right Side Contect Form Section
            </h4>
